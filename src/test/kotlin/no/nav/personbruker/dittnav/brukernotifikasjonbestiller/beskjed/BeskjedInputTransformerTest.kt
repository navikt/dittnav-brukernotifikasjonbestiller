...
internal class BeskjedInputTransformerTest {
    ...
    fun `should transform from external to internal`() {
        val externalBeskjedInput = BeskjedTestData.beskjedInput()
    ...
    fun `should allow synligFremTil to be null`() {
        val externalNokkelInput = NokkelTestData.createNokkelInputWithEventId(eventId)
        val beskjedUtenSynligTilSatt = BeskjedTestData.createBeskjedInputWithSynligFremTil(null)
    ...
    fun `should allow text length up to the limit`() {
        ...
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithText(textWithMaxAllowedLength)
    ...
    fun `do not allow empty tekst`() {
        val emptyText = ""
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithText(emptyText)
    ...
    fun `do not allow too long tekst`() {
        ...
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithText(tooLongText)
    ...
    fun `do not allow too long link`() {
        ...
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithLink(tooLongLink)
    ...
    fun `do not allow invalid link`() {
        ...
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithLink(invalidLink)
    ...
    fun `should allow empty link`() {
        val emptyLink = ""
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithLink(emptyLink)
    ...
    fun `do not allow invalid sikkerhetsnivaa`() {
        ...
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithSikkerhetsnivaa(invalidSikkerhetsnivaa)
    ...
    fun `do not allow prefererteKanaler if eksternVarsling is false`() {
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithEksternVarslingAndPrefererteKanaler(eksternVarsling = false, prefererteKanaler = listOf(PreferertKanal.SMS.toString()))
        shouldThrow<FieldValidationException> {
            runBlocking {
                BeskjedInputTransformer.toInternal(externalNokkelInput, externalBeskjedInput)
            }
    ...
    fun `do not allow unknown preferert kanal`() {
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithEksternVarslingAndPrefererteKanaler(eksternVarsling = true, prefererteKanaler = listOf("unknown"))
        shouldThrow<FieldValidationException> {
            runBlocking {
                BeskjedInputTransformer.toInternal(externalNokkelInput, externalBeskjedInput)
            }
    ...
    fun `should allow empty prefererteKanaler`() {
        val externalNokkelInput = NokkelTestData.createNokkelInput()
        val externalBeskjedInput = BeskjedTestData.createBeskjedInputWithEksternVarslingAndPrefererteKanaler(eksternVarsling = true, prefererteKanaler = emptyList())
        val (_, transformedBeskjed) = BeskjedInputTransformer.toInternal(externalNokkelInput, externalBeskjedInput)
